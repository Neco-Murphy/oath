...
var defer = function (value,status) {
  return new Deferred(new Promise(value,status));
};

var promisify =  function(nodeStyle){
  return function(big){
    //nodeStyle(big, this.sucess: sucess)
    return new Promise(nodeStyle);
    //callback.call(argments);
  };
};
